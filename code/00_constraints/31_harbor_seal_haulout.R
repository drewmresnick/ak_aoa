##############################################################################
### 31. Alaska Harbor Seal Haul-out Locations 500m Buffer,	ak_cs_053      ###
############################################################################## 
  ...
  tryCatch({
    ...
    clean_data <- function(raw_data){
      data_layer <- raw_data %>%
        ...
        # create field called "layer" and fill with "harbor seal haulouts" for summary
        dplyr::mutate(layer = "harbor seal haulouts")
      return(data_layer)
    }
