####################################################
### 12. Coastal Maintained Channels,	ak_cs_010  ###
####################################################
  ...
  tryCatch({
    ...
    clean_data <- function(raw_data){
      data_layer <- raw_data %>%
        ...
        # create field called "layer" and fill with "coastal maintained channels" for summary
        dplyr::mutate(layer = "coastal maintained channels")
      return(data_layer)
    }

    # Load Coastal Maintained Channels and pass it through the cleaning function above
    ## source: https://encdirect.noaa.gov/theme_layers/data/coastal_maintained_channels/maintainedchannels.zip
