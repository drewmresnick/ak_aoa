############################################################
### 13. Munitions and Explosives of Concern,	ak_cs_012  ###
############################################################
  ...
  tryCatch({
    ...
    clean_data <- function(raw_data){
      data_layer <- raw_data %>%
        ...
        # create field called "layer" and fill with "munitions and explosives" for summary
        dplyr::mutate(layer = "munitions and explosives")
      return(data_layer)
    }
    
    # Load Munitions and Explosives of Concern and pass it through the cleaning function above
