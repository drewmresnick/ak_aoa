  ...
  tryCatch({
    ...
    clean_data <- function(raw_data){
      data_layer <- raw_data %>%
        ...
        dplyr::mutate(layer = "anchorages") %>%
      return(data_layer)
    }
    
    # Load Anchorages and pass it through the cleaning function above
    ## source: https://marinecadastre-noaa.hub.arcgis.com/datasets/noaa::anchorages/about		
    ### data
