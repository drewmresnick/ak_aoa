#############################################################
### 7. NOAA Charted Submarine Cables, ak_cs_005           ###
#############################################################
...
for(i in 1:length(code_dict$study_area)){
  ...
  tryCatch({
    ...
    # Load NOAA Charted Submarine Cables and pass it through the cleaning function above
    ## source: https://marinecadastre.gov/downloads/data/mc/SubmarineCable.zip
