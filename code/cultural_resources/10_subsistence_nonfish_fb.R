##################################################################################
### 10. Subsistence harvest non fisheries resources	ak_cr_003 floating bag     ###
################################################################################## 
...
for(i in 1:length(code_dict$study_area)){
  ...
  tryCatch({
    ...
    intermediate_gpkg <- paste(study_area_dir, dict_study, "b_intermediate_data/cultural_resources/cultural_resources_fb.gpkg", sep = "/")
    ...
    submodel_gpkg <- paste(study_area_dir, dict_study, "c_submodel_data/cultural_resources/cultural_resources_fb.gpkg", sep = "/")
