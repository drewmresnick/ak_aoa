...
for(i in 1:length(code_dict$study_area)){
  ...
  suitability_output_gpkg <- file.path("C:/Users/Breanna.Xiong/Documents/R Scripts/ak_aoa/study_area", code_dict$study_area[i], "3_suspended/d_suitability_data/constraints/constraints_suitability.gpkg")
  
  # Create the new layer name based on the study area
  new_layer_name <- paste("ak", code_dict$code[i], "unconstrained_suspended", sep = "_")
