##################################################################
### 32. Steller Sea Lion Haul-out 500m Buffers	ak_cs_038      ###
################################################################## 
  ...
  tryCatch({
    ...
    clean_data <- function(raw_data){
      data_layer <- raw_data %>%
        ...
        # create field called "layer" and fill with "steller sea lion haulout buff" for summary
        dplyr::mutate(layer = "steller sea lion haulout buff")
      return(data_layer)
    }
    
    
    # Load Steller Sea Lion Haul-out 500m Buffers and pass it through the cleaning function above
    ## source: https://data.axds.co/gs/mariculture/wfs?service=WFS&version=1.0.0&request=GetFeature&outputFormat=SHAPE-ZIP&typeName=mariculture:steller_sea_lion_haulout_buffers
    ## metadata: https://portal.aoos.org/?portal_id=121#metadata/181cd683-4e7c-4460-a882-90cab7efbc09/19d67a99-7d6d-41a7-8692-61c65845b95e
    ### data
