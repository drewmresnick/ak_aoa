############################################### 
### 36. Ocean disposal sites	ak_cs_050     ###
############################################### 
...
for(i in 1:length(code_dict$study_area)){
  ...
  # Load Ocean disposal sites and pass it through the cleaning function above
  ## source: https://marinecadastre.gov/downloads/data/mc/OceanDisposalSite.zip
