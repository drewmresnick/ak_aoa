########################################################################################################
### 24. Alaska DEC Seafood Processing Facilities: AKG5253000 Offshore Seafood Processors,	ak_cs_030  ###
########################################################################################################
...
for(i in 1:length(code_dict$study_area)){
  ...
  # Load Alaska DEC Seafood Processing Facilities: AKG523000 Offshore Seafood Processors Permitted Vessel
  ## Source: https://dec.alaska.gov/arcgis/rest/services/Water/Seafood_Processing/MapServer/6
  ### data
