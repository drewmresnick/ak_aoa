##########################################################################################################################
### 24. Alaska DEC Seafood Processing Facilities: AKG5253000 Offshore Seafood Processors Permitted Vessels,	ak_cs_030  ###
##########################################################################################################################
  ...
  tryCatch({
    ...
    clean_data <- function(raw_data){
      data_layer <- raw_data %>%
        ...
        # create field called "layer" and fill with "seafood processors permit vessels" for summary
        dplyr::mutate(layer = "seafood processors permit vessels")
      return(data_layer)
    }
