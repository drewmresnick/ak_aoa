...
### data
read_data <- sf::st_read(dsn = raw_constraints_gpkg, layer = "ak_cs_007") %>% clean_data()
...
# Export data
## submodel geopackage
sf::st_write(obj = read_data, dsn = submodel_gpkg, "ak_cs_007", append = F)

## intermediate geopackage
sf::st_write(obj = read_data, dsn = intermediate_gpkg, "ak_cs_007", append = F)
