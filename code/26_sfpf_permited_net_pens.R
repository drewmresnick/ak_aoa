########################################################################################################
### 26. Alaska DEC Seafood Processing Facilities: AKG130000 Permitted Net Pens	ak_cs_032            ###
########################################################################################################
...
for(i in 1:length(code_dict$study_area)){
  ...
  # Load Alaska DEC Seafood Processing Facilities: AKG130000 Permitted Net Pens and pass it through the cleaning function above
  ## REST Service: https://dec.alaska.gov/arcgis/rest/services/Water/Seafood_Processing/MapServer/13
  ### data
