################################################## 
### 37. Oil and Gas pipelines	ak_cs_051        ###
################################################## 
...
for(i in 1:length(code_dict$study_area)){
  ...
  # Load Oil and Gas pipelines and pass it through the cleaning function above
  ## source: https://marinecadastre.gov/downloads/data/mc/Pipeline.zip	
  ## metadata: https://www.fisheries.noaa.gov/inport/item/66172
  ### data
