################################################## 
### 38. Oil and gas platforms	ak_cs_052        ###
################################################## 
...
for(i in 1:length(code_dict$study_area)){
  ...
  # Load Oil and gas platforms and pass it through the cleaning function above
  ## source: https://marinecadastre.gov/downloads/data/mc/OffshoreOilGasPlatform.zip
  ## metadata: https://www.fisheries.noaa.gov/inport/item/66162
  ### data
