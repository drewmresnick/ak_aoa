##################################################################
### 29. Pacific Walrus Buffered Haulouts 1852-2016	ak_cs_035  ###
################################################################## 
...
for(i in 1:length(code_dict$study_area)){
  ...
  clean_data <- function(raw_data){
    data_layer <- raw_data %>%
      # reproject the same coordinate reference system (crs) as the hexed study area
  ...
  # Load Pacific Walrus Buffered Haulouts 1852-2016 and pass it through the cleaning function above
  ## source: https://data.axds.co/gs/walrus/wfs?service=WFS&version=1.0.0&request=GetFeature&outputFormat=SHAPE-ZIP&typeName=walrus:hauloutsdb_buffer_3338_4326
  ## metadata: https://www.sciencebase.gov/catalog/item/57bf650ce4b0f2f0ceb75bdc
  ### data
