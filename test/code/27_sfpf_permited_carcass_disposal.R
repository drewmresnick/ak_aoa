############################################################################################################
### 27. Alaska DEC Seafood Processing Facilities: AKG130000 Permitted Carcass Disposal Site,	ak_cs_033  ###
############################################################################################################
...
for(i in 1:length(code_dict$study_area)){
  ...
  # Load Alaska DEC Seafood Processing Facilities: AKG130000 Permitted Carcass Disposal Site and pass it through the cleaning function above
  ## REST Service: https://dec.alaska.gov/arcgis/rest/services/Water/Seafood_Processing/MapServer/14
  ### data
